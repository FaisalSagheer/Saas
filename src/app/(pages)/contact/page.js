...
const Contact = () => {
  ...
  return (
    <>
      <ReactLenis root>
      <div className="bg-black text-white infiniteScroll">
        <div className="ele">
          <div className="flex justify-between items-center font-[font1] px-20 pt-10 leading-45">
            ...
            <div className="rotate-x-12 -rotate-y-16 transition-all ease-in-out mt-20 flex text-black bg-[#D3FD50] py-1 lg:py-0">
