...
import { Contrast, Heart } from "lucide-react";
      ...
      <div className="bg-black text-white infiniteScroll overflow-hidden">
        <div className="ele">
          <div className="flex justify-between items-center font-[font1] lg:px-20 pt-40 lg:pt-10 leading-45">
            ...
            <div className="rotate-x-12 -rotate-y-16 transition-all ease-in-out mt-20 flex text-black bg-[#D3FD50] py-0 lg:py-0">
              <div className="moveX flex items-center">
                <h2 className="font-[font2] text-5xl lg:text-[8vw] whitespace-nowrap uppercase leading-[0.7] pt-6 pb-2 lg:pb-0 lg:pt-10">
                  Hello@k72.ca
                </h2>
                <Contrast size={126} />
                <h2 className="font-[font2] text-5xl lg:text-[8vw] whitespace-nowrap uppercase leading-[0.7] pt-6 pb-2 lg:pb-0 lg:pt-10">
