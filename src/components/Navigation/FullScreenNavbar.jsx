...
function FullScreenNavbar() {
  ...
  return (
    <div className="hidden text-white h-screen w-full absolute bg-black overflow-hidden">
      ...
      <div>
        ...
        <div className="py-36" ref={linksRef}>
          {Navlinks.map((item) => (
            <div
              className="moveXparent origin-top border-y-1 border-white relative"
              key={item.id}
            >
              <Link href={item.href}>
                ...
                <div className="absolute top-0 flex text-black moveXchild">
                  <div className="moveX flex items-center bg-[#D3FD50]">
